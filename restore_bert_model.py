# -*- coding: utf-8 -*-
"""Restore_bert_model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12bAzKZWXAOxfQIzHlxCRIeP5SJddI4in
"""
...
#locations of all the models
locs = ['data/Bert_models/bert_model_T005','data/Bert_models/bert_model_T007','data/Bert_models/bert_model_T016','data/Bert_models/bert_model_T047']
...
class BERT:
  def return_tags(self,para):
    ...
    op_file_1 = open("data/para_tags.csv",'w')
  ...
  def return_tags_custom(self,para):
    final_tags = []
    for mod in models:
        para_split = para.split('.')
        para_split = [text_to_word_sequence(x) for x in para_split]
        ...
        for _ in range(len(final_tags)):
          for x in range(len(final_tags[_])):
            if final_tags[_][x] == 'O':
              ...
              final_tags[_][x] += ', ' + tags[_][x]
    op_file = open("data/para_tags_custom.csv",'w')
  ...
  def give_metrics(self):
    ...
    fig.savefig('acc_bar_graph.png',format='png', bbox_inches='tight')
